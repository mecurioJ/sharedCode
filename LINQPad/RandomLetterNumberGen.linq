<Query Kind="Program">
  <GACReference>System.Security, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a</GACReference>
  <GACReference>System.Security.Principal, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a</GACReference>
  <GACReference>System.ServiceModel.Security, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a</GACReference>
...
void Main()
{
	...
	//ascii is 65 to 90 for upper case
	var rGen = new RandomStringGenerator();
	rGen.MinUpperCaseCharacters = 3;
	//rGen.UpperCaseCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	rGen.UseLowerCaseCharacters = false;
	rGen.UseNumericCharacters = true;
	rGen.UseSpecialCharacters = false;
	
	for (int i = 0; i < 10; i++)
	{
		rGen.Generate("Lnnn").Dump();
	}
