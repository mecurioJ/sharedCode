...
"[Products].[Products].[Product Family]"	,
	  ...
	  var Levels = 
				MetaDataConnection
					.GetSchemaDataSet(
						AdomdSchema.sSchemaList[AdomdSchemaGuid.Levels].Id,new Microsoft.AnalysisServices.AdomdClient.AdomdRestrictionCollection()
							{
								new Microsoft.AnalysisServices.AdomdClient.AdomdRestriction("CATALOG_NAME",CatalogName),
								//new Microsoft.AnalysisServices.AdomdClient.AdomdRestriction("CUBE_NAME","Loans"),
								//new Microsoft.AnalysisServices.AdomdClient.AdomdRestriction("MeasureGroupID","FACT DDA"),
								//new Microsoft.AnalysisServices.AdomdClient.AdomdRestriction("MEMBER_UNIQUE_NAME","[Measures].[Product Count End of Period]"),
							})
							.Tables[0]
							.Rows.Cast<DataRow>()
							.Select(dr => new LevelSource(dr))
							.ToArray();
							
							
	  IEnumerable<HierarchySource> HierarchySources = 
				MetaDataConnection
					.GetSchemaDataSet(
						AdomdSchema.sSchemaList[AdomdSchemaGuid.Hierarchies].Id,new Microsoft.AnalysisServices.AdomdClient.AdomdRestrictionCollection()
							{
								new Microsoft.AnalysisServices.AdomdClient.AdomdRestriction("CATALOG_NAME",CatalogName),
								//new Microsoft.AnalysisServices.AdomdClient.AdomdRestriction("CUBE_NAME","Loans"),
								//new Microsoft.AnalysisServices.AdomdClient.AdomdRestriction("MeasureGroupID","FACT DDA"),
							...
							.Tables[0]
							.Rows.Cast<DataRow>()
							.Select(dr => new HierarchySource(dr, Levels));
	  

//TypeCast = dr.Field<Object>("INSTANCE_SELECTION") != null  ? dr.Field<Object>("INSTANCE_SELECTION").GetType().ToString() : String.Empty,
	...
	HierarchySources.Where(hSrc => hSrc.CubeName.Equals(cubeName)).Dump();
}

public class GroupingSource
{
	public GroupingSource (){}
	public GroupingSource (DataRow dr)
	{
		CatalogName = dr.Field<String>("CATALOG_NAME");
		CubeName = dr.Field<String>("CUBE_NAME");
		DimensionUniqueName = dr.Field<String>("DIMENSION_UNIQUE_NAME");
		HierarchyUniqueName = dr.Field<String>("HIERARCHY_UNIQUE_NAME");
		LevelUniqueName = dr.Field<String>("LEVEL_UNIQUE_NAME");
		LevelNumber = dr.Field<UInt32>("LEVEL_NUMBER");
		MemberName = dr.Field<String>("MEMBER_NAME");
		MemberUniquieName = dr.Field<String>("MEMBER_UNIQUE_NAME");
		MemberType = dr.Field<Int32>("MEMBER_TYPE");
		MemberCaption = dr.Field<string>("MEMBER_CAPTION");
		ChildrenCardinality = dr.Field<UInt32>("CHILDREN_CARDINALITY");
		ParentLevel = dr.Field<UInt32>("PARENT_LEVEL");
		ParentUniqueName = dr.Field<String>("PARENT_UNIQUE_NAME");
		ParentCount = dr.Field<UInt32>("PARENT_COUNT");
		Description = dr.Field<String>("DESCRIPTION");
		Expression = dr.Field<String>("EXPRESSION");
		MemberKey = dr.Field<String>("MEMBER_KEY");
		IsPlaceHolder = dr.Field<bool>("IS_PLACEHOLDERMEMBER");
		IsDataMember = dr.Field<bool>("IS_DATAMEMBER");
	}
	...
	public UInt32 LevelNumber {get;set;}
	public String MemberName {get;set;}
	public String MemberUniquieName {get;set;}
	public Int32 MemberType {get;set;}
	public String MemberCaption {get;set;}
	public UInt32 ChildrenCardinality {get;set;}
	public UInt32 ParentLevel {get;set;}
...
public class LevelSource
{
	...
	public LevelSource(DataRow dr)
	{
		CatalogName = dr.Field<string>("CATALOG_NAME");
		CubeName = dr.Field<string>("CUBE_NAME");
		DimensionUniqueName = dr.Field<string>("DIMENSION_UNIQUE_NAME");
		HierarchyUniqueName = dr.Field<string>("HIERARCHY_UNIQUE_NAME");
		LevelName = dr.Field<string>("LEVEL_NAME");
		LevelUniqueName = dr.Field<string>("LEVEL_UNIQUE_NAME");
		LevelCaption = dr.Field<string>("LEVEL_CAPTION");
		LevelNumber = dr.Field<uint>("LEVEL_NUMBER");
		LevelType = dr.Field<int>("LEVEL_TYPE");
		Description = dr.Field<string>("DESCRIPTION");
	}
...
{
	public HierarchySource (){}
	public HierarchySource (DataRow dr)
	{
		CubeName = dr.Field<string>("CUBE_NAME");
		DimensionUniqueName = dr.Field<string>("DIMENSION_UNIQUE_NAME");
		HierarchyUniqueName = dr.Field<string>("HIERARCHY_UNIQUE_NAME");
		HierarchyName = dr.Field<string>("HIERARCHY_NAME");
		HierarchyCaption = dr.Field<string>("HIERARCHY_CAPTION");
		DefaultMember = dr.Field<string>("DEFAULT_MEMBER");
		AllMember = dr.Field<string>("ALL_MEMBER");
		DimensionIsVisible = dr.Field<bool>("DIMENSION_IS_VISIBLE");
		HierarchyIsVisible = dr.Field<bool>("HIERARCHY_IS_VISIBLE");
	}
	
	
	public HierarchySource (DataRow dr, IEnumerable<LevelSource> levels)
	{
		CubeName = dr.Field<string>("CUBE_NAME");
		DimensionUniqueName = dr.Field<string>("DIMENSION_UNIQUE_NAME");
		HierarchyUniqueName = dr.Field<string>("HIERARCHY_UNIQUE_NAME");
		...
		DimensionIsVisible = dr.Field<bool>("DIMENSION_IS_VISIBLE");
		HierarchyIsVisible = dr.Field<bool>("HIERARCHY_IS_VISIBLE");
		Levels = levels.Where(lvl => 
			lvl.CubeName.Equals(dr.Field<string>("CUBE_NAME"))
			&& lvl.HierarchyUniqueName.Equals(dr.Field<string>("HIERARCHY_UNIQUE_NAME")))
			.OrderBy(lvl => lvl.LevelNumber)
			;
	}
	
	
	public string CubeName {set; get;}
	public string DimensionUniqueName {set; get;}
	public string HierarchyUniqueName {set; get;}
	public string HierarchyName {set; get;}
	public string HierarchyCaption {set; get;}
	public string DefaultMember {set; get;}
	public string AllMember {set; get;}
	public bool DimensionIsVisible {set; get;}
	public bool HierarchyIsVisible  {set; get;}
	public IEnumerable<LevelSource> Levels {get;set;}
}
