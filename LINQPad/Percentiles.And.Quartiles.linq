...
void Main()
{
	double[] numbers = {3.1, 2.6, 7.8, 3.5, 1.9, 2.3, 4.8, 5.4, 3.7, 4.5};
	
	Descriptive desp = new Descriptive(numbers);
	
	desp.Analyze();
	
//	desp.Result.FirstQuartile.Dump();
//	desp.Result.Median.Dump();
//	desp.Result.ThirdQuartile.Dump();
	
	desp.Result.Range.Dump();
	
	var zScore = (29/5.3)/25;
