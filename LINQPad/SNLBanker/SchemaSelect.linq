...
void Main()
{
	...
	//Restrictions.Add("DIMENSION_NAME", "[Customer]");
	  ...
	  var results = MetaDataConnection.GetSchemaDataSet(
	...
	XDocument SchemaObjects = XDocument.Parse(results);
	
	SchemaObjects.Save(@"c:\projects\BankingCustomerIntelligence_JHLive.Schema.xml");
