...
void Main()
{
	...
	var GetMeasures = OlapData.Cubes.SelectMany(cub => cub.MeasureGroups.SelectMany(mg => mg.Measures)).Dump();
	var GetAttributes = OlapData.Dimensions.SelectMany(cDim => cDim.Attributes);
