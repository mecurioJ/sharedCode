<Query Kind="Program">
  ...
  <Namespace>System.Runtime.InteropServices; // DllImport</Namespace>
  <Namespace>System.Security.Permissions; // PermissionSetAttribute</Namespace>
  <Namespace>System.Security.Principal; // WindowsImpersonationContext</Namespace>
</Query>

void Main()
{
	var xmla = "";
	using (var impUser = ImpersonateUser("","",""))
	{
		var doSomething...
	}
}
